...
public final class WorldPlayerRTTNotifyOuterClass {
  ...
  public interface WorldPlayerRTTNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .PlayerRTTInfo player_rtt_list = 7;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int PLAYER_RTT_LIST_FIELD_NUMBER = 7;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < playerRttList_.size(); i++) {
        output.writeMessage(7, playerRttList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < playerRttList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(7, playerRttList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "yer_rtt_list\030\007 \003(\0132\016.PlayerRTTInfoB\033\n\031em" +
