...
public final class AbilityMetaReInitOverrideMapOuterClass {
  ...
  public interface AbilityMetaReInitOverrideMapOrBuilder extends
    ...
    /**
     * <code>repeated .AbilityScalarValueEntry override_map = 11;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int OVERRIDE_MAP_FIELD_NUMBER = 11;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < overrideMap_.size(); i++) {
        output.writeMessage(11, overrideMap_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < overrideMap_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(11, overrideMap_.get(i));
      }
