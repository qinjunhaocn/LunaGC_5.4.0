...
public final class PlayerCookRspOuterClass {
  ...
  public interface PlayerCookRspOrBuilder extends
    ...
    /**
     * <code>repeated .ItemParam extral_item_list = 2;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int EXTRAL_ITEM_LIST_FIELD_NUMBER = 2;
    ...
    public static final int COOK_COUNT_FIELD_NUMBER = 3;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < extralItemList_.size(); i++) {
        output.writeMessage(2, extralItemList_.get(i));
      }
      if (cookCount_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < extralItemList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, extralItemList_.get(i));
      }
      if (cookCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\020extral_item_list\030\002 \003(\0132\n.ItemParam\022\022\n\n" +
      "cook_count\030\003 \001(\r\022$\n\013recipe_data\030\006 \001(\0132\017." +
      "CookRecipeData\022\023\n\013qte_quality\030\t \001(\r\022\035\n\ti" +
    ...
    internal_static_PlayerCookRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_PlayerCookRsp_descriptor,
        new java.lang.String[] { "ExtralItemList", "CookCount", "RecipeData", "QteQuality", "ItemList", "Retcode", });
    emu.grasscutter.net.proto.ItemParamOuterClass.getDescriptor();
    emu.grasscutter.net.proto.CookRecipeDataOuterClass.getDescriptor();
  }
